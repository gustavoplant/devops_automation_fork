...
```powershell
az vm create --resource-group "west-us-1" --name "vm-pqp" --image Ubuntu2204 --admin-username gustavo --admin-password 'SenhaForte123' --authentication-type password --location 'westus' --size "Standard_B1s"
```
